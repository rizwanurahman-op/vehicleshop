...
const StatCard = ({ label, value, sub, icon: Icon, gradient, textColor }: {
    ...
    return (
        <div className={cn("relative rounded-2xl p-4 sm:p-5 pr-4 sm:pr-16 shadow-sm hover:shadow-md transition-all overflow-hidden", gradient)}>
        ...
        <div className="space-y-6">
            ...
            {stats && (
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                    ...
                    <StatCard label="Principal Repaid" value={formatINR(stats.totalPrincipal ?? stats.totalPaid)}
                                        ...
                                        <div className="relative mt-auto pt-4 border-t border-border/60 border-dashed">
                                            <div className="flex items-end justify-between mb-3">
                                                ...
                                                <div className="text-right">
                                                    ...
                                                    <p className="text-xl font-mono font-bold text-emerald-500 tabular-nums whitespace-nowrap leading-none"><CurrencyDisplay amount={rep.amountPaid} /></p>
                                                </div>
                                            </div>
